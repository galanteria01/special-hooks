...
function useCardType(cardNumber) {
    ...
    var _a = React__default["default"].useState('Unknown'), cardType = _a[0], setCardType = _a[1];
    var _b = React__default["default"].useState([]), errors = _b[0], setErrors = _b[1];
...
function useValidateEmail(email) {
    ...
    var _a = React__default["default"].useState(false), isValid = _a[0], setIsValid = _a[1];
    React__default["default"].useEffect(function () {
...
function useRandomEmails(count) {
    ...
    var _a = React__default["default"].useState([]), emails = _a[0], setEmails = _a[1];
    React__default["default"].useEffect(function () {
        var randomEmails = [];
...
function useRandomColors(count) {
    ...
    var _a = React__default["default"].useState([]), colors = _a[0], setColors = _a[1];
    React__default["default"].useEffect(function () {
        var randomColors = [];
        for (var i = 0; i < count; i++) {
...
exports.useCardType = useCardType;
exports.useRandomColors = useRandomColors;
exports.useRandomEmails = useRandomEmails;
